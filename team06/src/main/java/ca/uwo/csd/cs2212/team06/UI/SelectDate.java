/**
 * JCommon : a free general purpose class library for the Java(tm) platform (C) Copyright 2000-2005, 
 * by Object Refinery Limited and Contributors. Project Info:  http://www.jfree.org/jcommon/index.html
...
public class SelectDate extends JPanel implements ActionListener {
    ...
    private Calendar chosenDate;             //The date selected in the panel
    private Color chosenDateButtonColor;     //The color for the selected date
    private Color chosenMonthButtonColor;    //The color for dates in the current month
    private Color chosenOtherButtonColor;    //The color for dates that are visible, but not in the current month
    private int firstDayOfWeek;              //The first day-of-the-week
    private int yearSelectionRange = 20;     //The range used for selecting years
    private Font dateFont = new Font("SansSerif", Font.PLAIN, 10);  //The font used to display the date
    ...
    private JButton[] buttons;               //An array of buttons used to display the days-of-the-month.
    private boolean refreshing = false;      //A flag that indicates whether or not we are currently refreshing the 
                                             //buttons 
 ...
 */
    public SelectDate(final Calendar calendar, final boolean controlPanel) {
 ...
 */
    private JPanel getCalendarPanel() {
        ...
        for (int i = 0; i < this.WEEK_DAYS.length; i++) {
            ...
            JLabel next = new JLabel(weekDays[this.WEEK_DAYS[i]], 
                    SwingConstants.CENTER);
 ...
 * @return boolean, true if the date matches, false otherwise
 */
...
* @return years          a vector of years
*/
 ...
 * @param chosenOtherButtonColor     new colour to be set
 */
